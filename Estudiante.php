    ...
    <div class="d-flex">
        <div class="sidebar d-flex flex-column">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="#"><i class="bi bi-speedometer2"></i> Gestion vacantes</a>
                <a class="nav-link" href="#"><i class="bi bi-table"></i> Administrar </a>
                <a class="nav-link" href="#"><i class="bi bi-grid"></i> Borrar</a>
            </nav>
            <div class="mt-auto text-center">
                <hr>
                <i class="fa-solid fa-user-tie"> Estudiante</i>
