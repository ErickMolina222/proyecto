      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="../Administrador/Admin.html">volver</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<div class="container mt-5">
  ...
  <div class="mb-4 text-end">
    <a href="#" id="btnCrear" class="btn-crear-articulo">
      <i class="fa-solid fa-circle-plus"></i> Crear Artículo
    </a>
  </div>
        ...
        <div class="list-group-item d-flex justify-content-between align-items-center">
          <div>
            ...
            <?php if (!empty($producto['urlConsulta'])): ?>
              <a href="../Documentos/<?php echo $carpetaCarrera; ?>/<?php echo $producto['urlConsulta']; ?>" 
                target="_blank" class="btn-ver-documento">
          ...
          <div>
            ...
            <button class="btn-eliminar-articulo" onclick="eliminarArticulo(<?php echo $producto['id_pa']; ?>)">
  ...
  <div id="formularioArticulo" class="card p-4 d-none">
    <h3 class="mb-4 text-center">Artículo</h3>
    <form action="conProAc.php" method="POST" enctype="multipart/form-data" id="formArticulo">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Título del artículo" required>
      </div>

      <div class="mb-3">
        <label>Estado</label>
        <select name="estatus" class="form-select" id="estatus" required>
      ...
      <button type="submit" class="btn-guardar-articulo">
        <i class="fa-solid fa-floppy-disk"></i> Guardar
      </button>

      <button type="button" id="btnCancelar" class="btn-cancelar-articulo">
        <i class="fa-solid fa-xmark-circle"></i> Cancelar
      </button>
    </form>
  </div>
...
function cargarFormularioEditar(id, titulo, estatus, fechaInicio, fechaTermino) {
  ...
  document.getElementById('estatus').value = (estatus === "Realizado") ? "1" : "2";
